...
<head>
    ...
    <style>
        ...
        .story-output {
            margin-top: 20px;
            padding: 20px;
            background: rgba(255, 255, 255, 0.2); /* Lighter background for story output */
            border-radius: 10px;
            color: #f5deb3; /* Wheat color for output text */
            min-height: 150px; /* Minimum height for story output */
        }
    </style>
</head>
<body>
