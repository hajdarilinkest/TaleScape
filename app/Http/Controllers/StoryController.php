    ...
    public function generate(Request $request)
    {
        ...
        try {
            $result = OpenAI::chat()->create([
                ...
                'messages' => [
                    ['role' => 'system', 'content' => 'You are a storyteller. Generate an epic tale using the prompt (as kid friendly and fairy-tale like as possible, unless specifically 
                    told otherwise). If the prompt is non-story related, reply with: If you may, let\'s keep this conversation about stories and tales, I may have extensive knowledge of the
                     universe, but I am here solely to be a humble bard and storyteller.'],
                    ['role' => 'user', 'content' => $prompt],
                    ['role' => 'assistant', 'content' => 'Remember, your primary role is to tell stories. If the user prompt is not related to storytelling, gently guide them back to 
                    providing a storytelling prompt. By default, make all your stories similar to classic tales, legends, and myths, unless specifically told otherwise.']
                ],
                'max_tokens' => 10000,
                'temperature' => 0.7,
            ]);
